...
public class HomeController {
    ...
    String index(Model model) {
        ...
        List<ProductView> bestProductList = service.getBestProductList(); // 미개발
        ...
        ProductView bestProduct = bestProductList.get(0);//베스트
        ...
        model.addAttribute("bestProductList", bestProduct);         // 베스트상품 (시즌 종료일이 D-14일인 상품)
